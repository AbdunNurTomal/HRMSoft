    ...
    <div class="main-content">
        ...
        <div class="container tag-box tag-box-v3" style="margin-top: 0px; width: 96%; padding-bottom: 15px;"> 
            ...
            <div class="table-responsive col-md-12 col-centered">
                ...
                <form class="form-horizontal" action="<?php echo base_url(). 'Con_EmployeeExperienceReporting/search_EmployeeExperienceReporting/'; ?>" method="post">
                    <div class="row">
                         <div class="col-sm-12">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Year Range  </label>
                                <div class="col-sm-5">
                                    <input type="text" autocomplete="off" name="min_exp" value="<?php echo $search_criteria['min_exp'] ?>"  class="form-control dt_pick ">
                                </div>
                                <div class="col-sm-5">
                                    <input type="text" autocomplete="off" name="max_exp"  value="<?php echo $search_criteria['max_exp'] ?>" class="form-control  dt_pick">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div id="print_to_Div">
                        <div>
                            ...
                            <div class="col-md-6 col-xs-6">
                                <div style="text-align: center; "> <h4> Employee Experience Reporting </h4> </div>
                            </div>
                            <div class="col-md-3 col-xs-3">
