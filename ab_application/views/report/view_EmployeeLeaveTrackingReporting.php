    ...
    <div class="main-content">
        ...
        <div class="container tag-box tag-box-v3" style="margin-top: 0px; width: 96%; padding-bottom: 15px;"> 
            ...
            <div class="table-responsive col-md-12 col-centered">
                ...
                <form class="form-horizontal" action="<?php echo base_url(). 'Con_EmployeeLeaveTracking/search_EmployeeLeaveTrackingReporting/'; ?>" method="post">
                    <div class="row">
<!--                       <div class="col-sm-12"> 
                         <div class="col-sm-3">
                           <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select name="leave_type" id="leave_type" class="col-sm-12 col-xs-12 myselect2 input-sm" >
                                        <option></option>
                                        <?php 
                                        foreach ($main_employeeleavetypes->result() as $key): ?>
                                            <option value="<?php echo $key->id ?>"><?php echo $key->leave_short_code ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select name="leave_type" id="leave_type" class="col-sm-12 col-xs-12 myselect2 input-sm" >
                                        ...
                                        <?php 
                                        foreach ($main_employeeleavetypes->result() as $key):
                                         $slct = ($search_criteria['leave_type'] == $key->id) ? 'selected' : '';
                                        ?>
                                            <option value="<?php echo $key->id ?>"<?php echo $slct; ?>><?php echo $key->leave_short_code ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div id="print_to_Div">
                        <div>
                            ...
                            <div class="col-md-6 col-xs-6">
                                <div style="text-align: center; "> <h4> Employee Leave Tracking Reporting </h4> </div>
                            </div>
                            <div class="col-md-3 col-xs-3">
                    ...
                    <tbody>
                        ...
                        if ($search_data) {
                            ...
                            foreach ($search_data as $row) {          
                                ...
                                <td><?php echo $this->Common_model->get_name($this, $row->leave_type, 'main_employeeleavetypes', 'leave_short_code') ?></td>
                                <td><?php echo $row->used_hour ?></td>
