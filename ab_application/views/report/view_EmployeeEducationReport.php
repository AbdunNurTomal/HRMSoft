    ...
    <div class="main-content">
        ...
        <div class="container tag-box tag-box-v3" style="margin-top: 0px; width: 96%; padding-bottom: 15px;"> 
            ...
            <div class="table-responsive col-md-12 col-centered">
                ...
                <form class="form-horizontal" action="<?php echo base_url(). 'Con_EmployeeEducationReporting/search_EmployeeEducationReporting/'; ?>" method="post">
                    <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <select name="educationlevel" id="educationlevel" class="col-sm-12 col-xs-12 myselect2 input-sm" >
                                        ...
                                        <?php foreach ($educationlevel_query->result() as $key): ?>
                                            <?php $slct = ($search_criteria['educationlevel'] == $key->id) ? 'selected' : ''; ?>
                                            <option value="<?php echo $key->id ?>" <?php echo $slct; ?>><?php echo $key->educationlevelcode ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <select name="employee_name" id="employee_name" class="col-sm-12 col-xs-12 myselect2 input-sm">
                                        ...
                                        foreach ($employee_query->result() as $key):
                                            ?>
                                            <?php $slct = ($search_criteria['employee_name'] == $key->id) ? 'selected' : ''; ?>
                                ...
                                <div class="col-sm-8">
                                    <select name="position_id" id="position_id" class="col-sm-12 col-xs-12 myselect2 input-sm" >
                                        ...
                                        foreach ($positions_query->result() as $key):
                                            ?>
                                            <?php $slct = ($search_criteria['position_id'] == $key->positionname) ? 'selected' : ''; ?>
                    ...
                    <div id="print_to_Div">
                        <div>
                            ...
                            <div class="col-md-6 col-xs-6">
                                <div style="text-align: center; "> <h4> Employee Education Reporting </h4> </div>
                            </div>
                            <div class="col-md-3 col-xs-3">
                    ...
                    <tbody>
                        ...
                        if ($search_data) {
                            ...
                            foreach ($search_data as $row) {
                                ...
                                <td><?php echo $this->Common_model->get_name($this, $row->educationlevel, 'main_educationlevelcode', 'educationlevelcode') ?></td>
                                <td><?php echo $row->institution_name;?></td>
                                <td><?php echo $row->no_of_years;?></td>
                                <td><?php echo $row->certification_degree;?></td>
                                <?php
