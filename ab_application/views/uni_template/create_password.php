...
<body id='loginscreen'>
                                ...
                                <div class="col-sm-6 col-sm-offset-3 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
                                    <div class="main-form">
                                        ...
                                        <div class="form-title text-center">
                                            <h3 id="reset-password-modal-title">Let’s Create Your Password</h3>
                                        </div>
                                        ...
                                        <?php if ($passwordResetHash == "000"): ?>
                                            <div class="row text-center" style="margin-top: 30px;">
                                                ...
                                                <div class="col-sm-8">
                                                    <p class="bg-danger" style="padding: 20px;">Password link expired or invalid. <br> Please try again.</p>
                                                </div>
                                            </div>
                                            <br>
                                            <br>
                                        ...
                                        <div id="invalid-password-reset-message-div" style="display: none;">
                                            <div class="row text-center" style="margin-top: 30px;">
                                                <div class="col-sm-2"></div>
                                                <div class="col-sm-8">
                                                    <p id="reset-password-modal-message" class="bg-danger" style="padding: 20px;">Password link expired or invalid. <br> Please try again.</p>
                                                </div>
                                            </div>
                                            <br>
                                            <br>
                                        ...
                                        <div id="reset-password-form" class="form-middle-content clearfix">
                                            <form action="<?php echo site_url('Chome/save_new_password') ?>" class="loginform" method="post" id="create_password_form">
    ...
    <script type="text/javascript">
        $(function() {
            $( "#create_password_form" ).submit(function( event ) {
                //alert (base_url);
                ...
                var url = $(this).attr('action');
                    ...
                    if (data.indexOf("Your new password has been saved") != -1) {
