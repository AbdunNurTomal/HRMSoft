    ...
    <div class="main-content">
        ...
        <div class="container tag-box tag-box-v3" style="margin-top: 0px; width: 96%; padding-bottom: 15px;"> 
            ...
            <div class="table-responsive col-md-12 col-centered">
                ...
                <form class="form-horizontal" action="<?php echo base_url(). 'Con_Interview_Candidate_Reporting/search_Interview_Candidate_Reporting/'; ?>" method="post">
                    <div class="row">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="col-sm-4 control-label">Candidate Status</label>
                                <div class="col-sm-8">
                                    <select name="candidate_status" id="candidate_status" class="col-sm-12 col-xs-12 myselect2 input-sm" >
                                        ...
                                        foreach ($candidate_status as $key=>$val):
                                            $slct = ($search_criteria['candidate_status'] == $key) ? 'selected' : '';
                                            ?>
                                            <option value="<?php echo $key ?>" <?php echo $slct ?>><?php echo $val ?></option>
                                            <?php
                                        endforeach;
                ...
                <div id="print_to_Div">
                        <div>
                            ...
                            <div class="col-md-6 col-xs-6">
                                <div style="text-align: center; "> <h4> Interview Candidate Listing Reporting </h4> </div>
                            </div>
                            <div class="col-md-3 col-xs-3">
