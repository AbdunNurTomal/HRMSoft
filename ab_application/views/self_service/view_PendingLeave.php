    ...
    <div class="main-content">
        ...
        <div class="container tag-box tag-box-v3 content-div" style="padding-bottom: 15px; padding-top: 15px;"> <!-- container well div -->
            ...
            <div class="table-responsive col-md-12 col-centered no-border">
                <table id="dataTables-example" class="table table-striped table-bordered table-hover table-wrap responsive-table">
                    <colgroup>
                        <col width="1%">
                        <col width="20%">
                        <col width="10%">
                    ...
                    <tbody>
                        ...
                        if ($query) {
                            foreach ($query->result() as $row) {
                                ...
                                // print"<td id='catB" . $pdt . "'>" . $this->Common_model->get_name($this, $row->leave_type, 'main_employeeleavetypes', 'leave_short_code') . "</td>";
