                ...
                <div class="row margin-bottom-10 margin-top-20">
                    <div class="col-md-4">
                        <div class="bg-light"><!-- You can delete "bg-light" class. It is just to make background color -->
                            ...
                            <p> 1. Please download sample <a class="" href="<?php echo base_url() . "Con_Bulk_pto_import/download_temeplete" ?>"> Template </a>.</p>
                    ...
                    <div class="col-md-8">
                        <div class="bg-light"><!-- You can delete "bg-light" class. It is just to make background color -->
                        <form id="employee_Upload_form" name="sky-form11" class="form-horizontal" method="post" action="<?php echo base_url(); ?>Con_Bulk_pto_import/Import_pto_employee" enctype="multipart/form-data" role="form">
                            
                            <div class="col-md-12" style="margin-top: 10px"> 
                                <div class="col-md-12 pull-right">
                                    <label class="col-sm-12 pull-right"><u><h4>PTO Period</h4></u></label>
                                </div>                                
                                <div class="form-group col-md-6 find_mar">
                                    <label class="col-sm-4 control-label pull-left">From : <span class="req"/></label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group col-md-6 find_mar">
                                    <label class="col-sm-4 control-label pull-left"> To :<span class="req"/></label>
                                    <div class="col-sm-8">
                            ...
                            <div class="col-md-12" style="margin-top: 10px">                                
                                <div class="form-group col-md-6 find_mar">
                                    <label class="col-sm-4 control-label pull-left">File Type <span class="req"/></label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group col-md-6 find_mar">
                                    <label class="col-sm-4 control-label pull-left"> &nbsp</label>
                                    <div class="col-sm-8">
...
<script type="text/javascript">
    ...
    $(function() {
        $('#emp_file_form').submit(function(e) {
            ...
            $.ajaxFileUpload({
                url             :base_url + './Con_Bulk_pto_import/pto_file_Upload/', 
                secureuri       :false,
