    ...
    <div class="main-content">
        ...
        <div class="container tag-box tag-box-v3" style="margin-top: 0px; width: 96%; padding-bottom: 15px;"> <!-- container well div -->
            ...
            <div class="table-responsive col-md-12 col-centered">
                <a class="btn btn-u btn-md" href="<?php echo base_url() . "Con_Employee_i9/add_Employee_I9" ?>"><span class="glyphicon glyphicon-plus-sign"></span> Add </a></br></br>
                        ...
                        if ($query) {
                            ...
                            foreach ($query->result() as $row) {
                                ...
                                print"<td><div class='action-buttons'>"
                                        . "<a href='" . base_url() . "Con_Employee_i9/download_pdf/" . $row->id . "' ><i class='fa fa-lg fa-download'>&nbsp;&nbsp;</i></a>"
                                        . "<a href='" . base_url() . "Con_Employee_i9/edit_entry/" . $row->id . "' ><i class='fa fa-lg fa-pencil-square-o'>&nbsp;&nbsp;</i></a>"
...
<script type="text/javascript">
    ...
    function delete_data(id) {
        ...
        if (r == true)
            window.location = url + "Con_Employee_i9/delete_entry/" + id;
        else
            return false;
    }
