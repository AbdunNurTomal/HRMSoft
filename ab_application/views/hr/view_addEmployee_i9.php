<div class="col-md-10 main-content-div">
    <div class="main-content">
        ...
        <div class="container tag-box tag-box-v3" style="margin-top: 0px; width: 96%; padding-bottom: 15px;">
            ...
            if ($type == 1) {//entry
                ?>
                <form id="sky-form11" name="sky-form11" class="form-horizontal" method="post" action="<?php echo base_url(); ?>Con_Employee_i9/save_ObI9" enctype="multipart/form-data" role="form">
    ...
    <!--                                                <input type="text" name="other_name" id="other_name" class="form-control input-sm" placeholder="Signature">-->
                ...
                <form id="sky-form11" name="sky-form11"  class="form-horizontal" method="post" action="<?php echo base_url(); ?>Con_Employee_i9/edit_ObI9" enctype="multipart/form-data" role="form" >
                    <?php
                                ...
                                <div class="form-group no-margin">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="onboarding_employee" id="onboarding_employee" class="col-sm-12 col-xs-12 myselect2 input-sm" disabled>
                                            ...
                                            $employees_candidate = $this->db->get_where('main_employees', array('company_id' => $this->company_id));
                                            if ($employees_candidate && ($employees_candidate->num_rows() > 0)) {
                                                foreach ($employees_candidate->result() as $key => $roww) {
                                                    $slct = ($row->employee_id == $roww->employee_id) ? 'selected' : '';
                                                    print"<option value='" . $roww->employee_id . "' " . $slct . ">" . $roww->first_name . ' ' . $roww->middle_name . ' ' . $roww->last_name . "</option>";
                                                }
                                            }
                                            ?>
                                        </select>
...
//                alert(data);
                var url = '<?php echo base_url() ?>Con_Employee_i9';
