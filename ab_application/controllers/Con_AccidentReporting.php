...
class Con_AccidentReporting extends CI_Controller {
    ...
    public function index($menu_id=0, $show_result = FALSE, $search_data = array(), $search_criteria = array('from_date'=>'','to_date'=>'','acc_type' => '','employee_name' => '','department_id' => '','position_id' => '')) {
        ...
        $param['page_header'] = "Employee Accident Reporting";
        ...
        $param['content'] = 'report/view_EmployeeAccidentReporting.php';
        $this->load->view('admin/home', $param);
    }
    
    public function search_AccidentReporting() {
        ...
        if (($from_date!='' && $to_date!='') ||$employee_name != '' || $acc_type != '' || $department_id != '' || $position_id != '') {
            ...
            $this->db->join('main_emp_actions', 'main_emp_actions.employee_id = main_employees.id','left');
            ...
            if ($from_date!='' && $to_date!='') {
                ...
                $this->db->where("main_emp_actions.action_date BETWEEN '".$from_date."' AND '".$to_date."'");
