...
class Con_Training_Feedback extends CI_Controller {
    ...
    public function index() {
        ...
        if ($this->user_group == 11 || $this->user_group == 12 || $this->user_group == 4 || $this->user_group == 1) {//Hr Manager //Company User //Admin //HR
            ...
            $this->db->where_in('main_training_status_details.employee_id', 0);
