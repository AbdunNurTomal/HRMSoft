...
class Con_obw4 extends CI_Controller {
    ...
    public function save_obw4() {
        ...
        $this->form_validation->set_rules('ob_eeo_type', 'Select Type', 'required', array('required' => "Please select the Required field, %s."));
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $insert_data['ob_eeo_type'] = $post_data['ob_eeo_type'];
    ...
    function edit_obw4() {
        ...
        if ($this->user_group <= 3) {
            ...
            $this->KurunthamModel->checkPageAccess("emp_w4", $id, $this->company_id);
        }
    ...
    public function ajax_get_candidate_data($ob_employee_id = '') {
     ...
     public function ajax_get_emp_candidate_data($ob_employee_id = '') {
